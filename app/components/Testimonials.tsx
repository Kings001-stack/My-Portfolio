      ...
      <div className="relative overflow-hidden rounded-2xl bg-gray-900/50 backdrop-blur-sm border border-gray-800 p-6">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-center">
            <p className="text-gray-300 italic mb-4 max-w-2xl">"{testimonials[activeIndex].text}"</p>
          ...
          <div className="flex items-center gap-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${index === activeIndex ? 'bg-primary w-4' : 'bg-gray-600'}`}
